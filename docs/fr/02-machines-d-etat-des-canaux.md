# 2. Machines d’état des canaux

Le premier mécanisme central du dépôt concerne machines d’état des canaux.
...
[Chapitre suivant : Routage, paiements et persistance](03-routage-paiements-et-persistance.md)
