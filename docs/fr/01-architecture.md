# 1. Architecture — Eclair

Ce dépôt rassemble les composants de référence consacrés à le nœud Lightning en Scala, les canaux, le routage et la gestion de paiements.
...
[Chapitre suivant : Machines d’état des canaux](02-machines-d-etat-des-canaux.md)
